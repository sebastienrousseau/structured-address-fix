...
"""The flagship CBPR+ UG2026 policy.

This policy encodes the November 2026 cliff: fully unstructured addresses
are rejected (``CRITICAL``, ``rejects_payment``), hybrid addresses are
permitted but their residual ``AdrLine`` is flagged (``WARNING``), and
fully structured addresses pass with only the shared structural checks
(non-ISO country, ``AdrLine`` overflow, structured-field overflow).
"""
...
class Cbpr2026Policy(BasePolicy):
    """CBPR+ UG2026 address policy — the package default."""

    id: ClassVar[str] = PolicyId.CBPR_2026.value
    title: ClassVar[str] = "SWIFT CBPR+ UG2026 (November 2026 cliff)"
