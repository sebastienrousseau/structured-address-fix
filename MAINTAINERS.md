...
The people who can merge PRs and cut releases for `structured-address-fix` and
the sibling packages that depend on it in the sebastienrousseau ISO 20022 suite.
See [`GOVERNANCE.md`](GOVERNANCE.md) for roles, decision making, and how to
